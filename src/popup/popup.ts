import { DECREMENT_PLAYBACK_RATE_KEY, INCREMENT_PLAYBACK_RATE_KEY, SEEK_BACKWARD_KEY, TOGGLE_PLAY_PAUSE_KEY, SEEK_FORWARD_KEY, RESET_PLAYBACK_RATE_KEY } from "../common/keyboard-shortcuts";
